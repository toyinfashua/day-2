...
describe("words()", function() {
  ...
  it("counts tabs", function() {
    var expectedCounts = { hello: 1, world: 1 };
    expect(wcount.words("hello\tworld")).to.equal(expectedCounts);
  });
  ...
  it("handles properties that exist on Object’s prototype", function() {
    ...
    expect(wcount.words("reserved words like prototype and toString ok?")).to.equal(expectedCounts);
  });
});
});